...
@section('main-content')
	...
	<div class="lead">
		<a href="/newtechnology" class="btn btn-lg btn-default">Nuova tecnologia</a>
	</div>
	<div class="lead">
			...
			$.ajax({
			  ...
			  success: function(data) {
				...
				for(var key in data.technologies) {
					row = $("<tr><td>" + data.technologies[key].name + "</td><td>" + data.technologies[key].notes + '</td><td><button class="btn btn-lg btn-default glyphicon glyphicon-remove" id="delete" value="'+ data.technologies[key].id +'"></button></td></tr>');
					table.append(row);
				}
