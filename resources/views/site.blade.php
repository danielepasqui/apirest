		...
		$(document).ready(function(){
			$.ajax({
			  ...
			  success: function(data) {
				var row;
				row = $("<tr><td>" + data.site.nome + "</td><td> " + data.site.url + "</td><td> " + data.site.pm + "</td><td> " + data.site.support_queue + '</td><td> ' + data.site.technology + '</td><td> ' + data.site.machine + '</td><td> ' + data.site.doc_root + '</td><td> ' + data.site.group + '</td><td> ' + data.site.cms_admin + '</td><td> ' + data.site.cms_pass + '</td><td> ' + data.site.auth_name + '</td><td> ' + data.site.auth_pass + '</td>');
				...
				$('#table').append(row);
				for(var key in data.site.databases) {
					$('#db_host'+data.site.id).append(data.site.databases[key].host + '<br/>');
					$('#db_user'+data.site.id).append(data.site.databases[key].username + '<br/>');
					$('#db_pass'+data.site.id).append(data.site.databases[key].password + '<br/>');
					$('#db_name'+data.site.id).append(data.site.databases[key].db_name + '<br/>');
				}
			  },
			  type: 'GET'
		   });
